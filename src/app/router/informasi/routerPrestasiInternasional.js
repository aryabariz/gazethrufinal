...
import PrestasInternasional from '../../layout/informasi/Prestasi/prestasiInternasional'


export default class routerPrestasiInternasional extends Component{
    constructor(props){
        super(props);
        this.state={
            klikBtn1: 0,
